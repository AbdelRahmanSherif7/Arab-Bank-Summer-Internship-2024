...
public class Client {
    ...
    public Client(Long id, String firstName, String lastName, String email, String password, BigDecimal balance, String hasCreditCard, int childrenCount, int loyaltyPoints) {
        this.id = id;
    ...
    public Client hasCreditCard(String hasCreditCard) {
        setHasCreditCard(hasCreditCard);
        return this;
    }

    public Client childrenCount(int childrenCount) {
        setChildrenCount(childrenCount);
        return this;
    }

    public Client loyaltyPoints(int loyaltyPoints) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, client.id) && Objects.equals(firstName, client.firstName) && Objects.equals(lastName, client.lastName) && Objects.equals(email, client.email) && Objects.equals(password, client.password) && Objects.equals(balance, client.balance) && Objects.equals(hasCreditCard, client.hasCreditCard) && childrenCount == client.childrenCount && loyaltyPoints == client.loyaltyPoints;
    }
